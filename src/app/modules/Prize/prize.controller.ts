...
const getPrizeDefinitions = catchAsync(async (req: Request, res: Response) => {
  const prizes = await prizeService.getContestPrizeDefinitions();

  sendResponse(res, {
    success: true,
    statusCode: httpStatus.OK,
    message: "Prize definitions fetched successfully",
    data: prizes,
  });
});
