...
export const defaultPrizeDefinitions: PrizeDefinition[] = [
  ...
  // Top 10-200 tiers are badge-only: no boost ("promote"), swap ("trade"), key ("charge"), or coin reward.
  topRankDefinition(10, awardTargets.PHOTO, { boost: 0, swap: 0, key: 0, coin: 0 }, true, 50),
  topRankDefinition(10, awardTargets.PHOTOGRAPHER, { boost: 0, swap: 0, key: 0, coin: 0 }, true, 60),
  topRankDefinition(20, awardTargets.PHOTO, { boost: 0, swap: 0, key: 0, coin: 0 }, true, 70),
  topRankDefinition(20, awardTargets.PHOTOGRAPHER, { boost: 0, swap: 0, key: 0, coin: 0 }, true, 80),
  topRankDefinition(50, awardTargets.PHOTO, { boost: 0, swap: 0, key: 0, coin: 0 }, true, 90),
  topRankDefinition(50, awardTargets.PHOTOGRAPHER, { boost: 0, swap: 0, key: 0, coin: 0 }, true, 100),
  topRankDefinition(100, awardTargets.PHOTO, { boost: 0, swap: 0, key: 0, coin: 0 }, true, 110),
  topRankDefinition(100, awardTargets.PHOTOGRAPHER, { boost: 0, swap: 0, key: 0, coin: 0 }, true, 120),
  topRankDefinition(200, awardTargets.PHOTO, { boost: 0, swap: 0, key: 0, coin: 0 }, true, 130),
  topRankDefinition(200, awardTargets.PHOTOGRAPHER, { boost: 0, swap: 0, key: 0, coin: 0 }, true, 140),
];
